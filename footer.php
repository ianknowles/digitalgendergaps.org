<footer class="bg-light">
	...
	<div class="d-flex flex-column flex-lg-row flex-wrap justify-content-center align-content-center">
		...
		<div class="align-self-center"><a href="https://www.sociology.ox.ac.uk/" target="_blank"><img class="m-2 p-2" style="background-color: #002147; height: 86px" alt="University of Oxford logo" src="<?php echo get_theme_file_uri('/assets/images/oxweb-logo-rect.svg'); ?>"></img></a></div>
		<div class="align-self-center"><a href="https://www.qcri.org.qa/" target="_blank"><img class="m-2 p-2" style="height: 86px" alt="Hamad Bin Khalifa University logo" src="<?php echo get_theme_file_uri('/assets/images/qcri28rgb29-01.svg'); ?>"></img></a></div>
