						...
						<div class="row" >
							...
							<div id="map-v-legend" class="col-lg-1 d-none d-lg-flex flex-lg-column pl-0">
								<div class="d-flex flex-row h-100">
									<div id="v-legend-gradient" class="align-self-center mr-1" style="width: 15px; height: 95%;"></div>
						...
						<div class="row d-flex d-lg-none">
							<div id="map-h-legend" class="col-12 col-lg-11">
								<div class="row d-flex justify-content-center align-items-center">
									<div id="h-legend-gradient" style="width: 92.5%; height: 15px;"></div>
								</div>
							...
							<div class="col-12 d-flex justify-content-between align-items-center flex-row">
								<div>
									<div class="input-group d-flex">
										<input type="color" id="color-inequality" class="align-self-stretch color-pick-size"></input>
										<button type="button" id="color-inequality-button" class="btn btn-outline-secondary color-pick-size"></button>
								...
								<div>
									<div class="input-group">
										...
										<input type="color" id="color-equality" class="color-pick-size color-pick-right"></input>
										<button type="button" id="color-equality-button" class="btn btn-outline-secondary color-pick-size"></button>
									</div>
								</div>
							</div>
						</div>
