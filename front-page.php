...
<div class="container-fluid position-absolute top-0" style="top:0">
	...
	<div class="jumbotron" style="background-color:#b8daff;">
		<div class="container">
			...
			<p>We show how big data can help close this gender data gap and measure progress towards this important development goal in real-time.</p>
			<!--
		...
		<div class="row">
			...
			<div class="col-md-4 py-2 py-md-0">
				<div class="row"><div class="col">
					...
					<p>See the background of the project, and an overview of how the data is collected and processed.</p>
				</div></div>
				<div class="row d-flex d-md-none"><div class="col">
